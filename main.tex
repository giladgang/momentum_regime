...
Out-of-sample on 167 months of U.S. equity data (2011--2025), only XGBoost survives long-short construction (Sharpe 1.11, six-factor alpha 24.7\%). The regime signal is essential: removing it reduces the Sharpe by more than 60\%. Model-free information coefficient analysis confirms that momentum's predictive structure shifts with market conditions in the raw data, independent of any model. Stress tests show the strategy can absorb a 12-month recession but is vulnerable to prolonged fundamental deterioration where beaten-down stocks never recover.
