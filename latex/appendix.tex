...
A detailed derivation of the Forward-Filtering Backward-Sampling (FFBS) algorithm used in Step~1 of the Gibbs sampler (Section~\ref{sec:gibbs_sampler}) is provided below. Figure~\ref{fig:ffbs_diagram} illustrates the two-pass structure.
