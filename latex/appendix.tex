...
Section~\ref{sec:risk_aversion} argues that embedding a risk penalty directly in the XGBoost training target degrades performance, motivating the two-model CRRA dual-utility specification used in the main text. Table~\ref{tab:alt_targets} shows this degradation is not an artefact of the mean-variance functional form: the same pattern appears under three families of training targets with varying risk tolerance.
