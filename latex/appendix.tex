...
The Sharpe ratio ranges from 0.93 to 1.12 across all configurations tested. The baseline (depth=4, lr=0.05, $n$=500) is not the single best configuration -- a lower learning rate (0.01) achieves a Sharpe of 1.12 -- but all variants substantially outperform unconditional momentum (Sharpe $\approx$ 0.70). The results are robust to reasonable hyperparameter perturbations.
