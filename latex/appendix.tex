...
All portfolios are rebalanced monthly: both the long and short legs are reconstituted every month using updated scores. Monthly rebalancing is essential for the regime-conditional strategy, as the holding period analysis in Section~\ref{sec:holding} shows that the reversal premium exploited during panic months dissipates within one month.
