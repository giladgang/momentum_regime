...
At the baseline depth of 4, the Sharpe ratio ranges from 0.89 to 1.11 across learning rate and ensemble size variations. Performance degrades at depths below 3 (see Section~\ref{sec:shap_results} for the depth analysis) and above 5 due to overfitting. The results confirm that M2's performance is not an artefact of a particular hyperparameter configuration.
