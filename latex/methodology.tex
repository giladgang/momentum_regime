...
\end{equation}
The pseudo-counts are $(9, 1)$ for the calm-state transitions and $(1, 9)$ for the panic-state transitions, so even before observing data the prior expects each regime to persist with probability $0.9$; the observed counts shift the expectation but rarely overturn the persistence pattern.
