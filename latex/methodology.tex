...
\end{equation}
The Dirichlet prior set earlier in this section places pseudo-counts $(9, 1)$ on the calm-state transitions and $(1, 9)$ on the panic-state transitions, encoding an expected persistence of $0.9$ in each regime before any data are observed; the observed transition counts shift the expectation but rarely overturn the persistence pattern.
