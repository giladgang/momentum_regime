...
\end{equation}
Values of $\hat{R}$ near 1.0 indicate convergence; the standard threshold is $\hat{R} < 1.1$. For the selected feature set (DD+DISP+REL\_N+CS), all parameters have $\hat{R} < 1.01$ across five independent chains (Appendix~\ref{app:gelman_rubin}).
