...
The priors encode two economic beliefs. First, before seeing the data, neither regime should be forced to have extreme values in any feature; the model should learn the characteristics of calm and panic states from the data. Second, regimes should be persistent rather than switching every few months. The first belief is realized in the prior on the emission parameters $(\boldsymbol{\mu}_k, \boldsymbol{\Sigma}_k)$, the second in the prior on the transition matrix $\mathbf{P}$, specified below.
