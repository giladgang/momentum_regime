...
\begin{figure}[H]
    \centering
    \vspace{-0.5cm}
    \includegraphics[width=0.88\textwidth]{gibbs_sampling_diagram.pdf}
    \vspace{-0.3cm}
...
Importantly, the backward pass is used only during training (the Gibbs sampler on 1990--2010 data) to improve posterior parameter estimates. The trading signal $\pi_t^{\text{filter}}$ relies solely on the causal forward filter.
