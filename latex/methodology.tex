...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{plots/markov_chain_diagram.png}
...
\begin{figure}[H]
    \centering
    \vspace{-0.5cm}
    \includegraphics[width=0.88\textwidth]{plots/gibbs_sampling_diagram.pdf}
    \vspace{-0.3cm}
