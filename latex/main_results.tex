...
\begin{enumerate}
    ...
    \item Section~\ref{sec:feature_results} examines which features drive the predictions through coefficient analysis and SHAP values.
    ...
    \item Section~\ref{sec:ablation} presents ablation studies that isolate the sources of the regime signal's value.
\end{enumerate}
