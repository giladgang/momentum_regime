...
print("=" * 80)
print("  HMM FEATURE SEARCH (LONG-SHORT, MOM+PI ONLY) — FULL PIPELINE MATCH")
print("=" * 80)
...
ALL_FEATURES_FULL = MOM_FEATURES + ['pi_filter', 'log_me'] + FUND_FEATURES
ALL_FEATURES = MOM_FEATURES + ['pi_filter']  # mom+pi only for D&M comparison
...
def run_portfolio_test(pi_df):
    ...
    try:
        ...
        X_tr_xgb = train_cs[ALL_FEATURES].values  # mom+pi only.astype(float)
