...
\bottomrule
\end{tabular}
\caption{Ridge regression baseline predicting continuous forward returns (same target as XGB). The Sharpe of $-$0.57 is robust across all regularisation strengths.}
\label{tab:ridge}
\end{table}
