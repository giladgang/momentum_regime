...
\bottomrule
\end{tabular}
\caption{Out-of-sample performance of XGBoost (XGB) under alternative training targets (long-only construction). Every risk-adjusted target reduces returns faster than volatility.}
