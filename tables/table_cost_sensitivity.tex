...
\bottomrule
\end{tabular}
\caption{Sharpe ratio sensitivity to one-way transaction costs (long-short). M2 remains profitable at 50\,bps (Sharpe 0.79). All other strategies become unprofitable at moderate cost levels.}
