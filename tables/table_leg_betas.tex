\begin{table}[H]
\centering
\caption{Leg-level CAPM betas by regime, 2011--2024 OOS test period. Panic months are those with $\pi_t^{\mathrm{filter}} \geq 0.5$. Newey--West standard errors (3 lags) in parentheses.}
\label{tab:leg_betas}
\begin{tabular}{llccc}
\toprule
